...
func CreateIndexes(db *gorm.DB) error {
	...
	indexes := []string{
		...
		"CREATE INDEX IF NOT EXISTS idx_tickets_scope_active_sla_created_id ON tickets(organization_id, project_id, created_at, id) WHERE sla_breached = TRUE AND status IN ('open','in_progress','pending');",
